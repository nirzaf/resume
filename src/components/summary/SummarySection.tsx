...
export const SummarySection: FC<Props> = ({ title, section }) => {
  return (
    <div className="mb-6 bg-gradient-to-br from-white to-[#E6F3FF] dark:bg-gray-900 rounded-lg p-4 sm:p-6 shadow-[0_2px_4px_rgba(6,7,225,0.01)] dark:shadow-[0_2px_4px_rgba(6,7,225,0.02)] w-full max-w-full overflow-hidden">
